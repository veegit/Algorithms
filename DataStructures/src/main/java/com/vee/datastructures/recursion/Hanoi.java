 ...
 * configuration. You are required to do the transformations in minimal number
 * of moves.
 * 
 * A move consists of picking the topmost disc of any one of the pegs and
 * placing it on top of anyother peg. At anypoint of time, the decreasing radius
 ...
 * 
 * 
 * Input Format: N K 2nd line contains N integers. Each integer in the second
 * line is in the range 1 to K where the i-th integer denotes the peg to which
 * disc of radius i is present in the initial configuration. 3rd line denotes
 * the final configuration in a format similar to the initial configuration.
 * 
 * 
 ...
 * move, by a peg number to pick from and a peg number to place on. If there are
 * more than one solutions, it's sufficient to output any one of them. You can
 * assume, there is always a solution with less than 7 moves and the initial
