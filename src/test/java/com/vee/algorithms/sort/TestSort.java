...
import com.vee.algorithms.sort.HeapSort;
import com.vee.algorithms.sort.MergeSort;
import com.vee.algorithms.sort.QuickSort;
import com.vee.algorithms.sort.QuickSort.PIVOT;
...
public class TestSort {
	...
	public static void main(String args[]){
		...
		assignment();
		//testHeapSort(in);*/
		Integer in[] = { 5, 3, 8, 9, 1, 7, 0, 2, 6, 4};
		testMergeSort(in);
	}
